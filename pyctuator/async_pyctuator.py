...
from pyctuator.impl.async_pyctuator_impl import AsyncPyctuatorImpl, AppInfo, BuildInfo, GitInfo, GitCommitInfo, AppDetails
...
class AsyncPyctuator:
    ...
    def __init__(
        ...
        * FastAPI - `app` is an instance of `fastapi.applications.FastAPI`
        ...
        # Instantiate an instance of AsyncPyctuatorImpl which abstracts the state and logic of the pyctuator
        self.pyctuator_impl = AsyncPyctuatorImpl(
        ...
        self.pyctuator_impl.register_environment_provider(AsyncOsEnvironmentVariableProvider())
        self.pyctuator_impl.register_health_providers(AsyncDiskSpaceHealthProvider(free_disk_space_down_threshold_bytes))
        self.pyctuator_impl.register_metrics_provider(AsyncMemoryMetricsProvider())
        self.pyctuator_impl.register_metrics_provider(AsyncThreadMetricsProvider())
        ...
        raise EnvironmentError("No async framework was found that is matching the target app "
    ...
    def register_async_environment_provider(self, provider: AsyncEnvironmentProvider) -> None:
        self.pyctuator_impl.register_environment_provider(provider)

    def register_health_provider(self, provider: AsyncHealthProvider) -> None:
        self.pyctuator_impl.register_health_providers(provider)

    def register_metrics_provider(self, provider: AsyncMetricsProvider) -> None:
        self.pyctuator_impl.register_metrics_provider(provider)
    ...
    def _integrate_fastapi(
        ...
        try:
            ...
            from pyctuator.impl.async_fastapi_pyctuator import AsyncFastApiPyctuator
