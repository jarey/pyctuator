...
class AsyncFastApiPyctuator(PyctuatorRouter):
    ...
    def __init__(
        ...
        if Endpoints.ENV not in disabled_endpoints:
            ...
            async def get_environment() -> EnvironmentData:
                return await pyctuator_impl.get_environment()
        ...
        if Endpoints.HEALTH not in disabled_endpoints:
            ...
            async def get_health(response: Response) -> object:
        ...
        if Endpoints.METRICS not in disabled_endpoints:
            ...
            async def get_metric_measurement(metric_name: str) -> Metric:
                return await pyctuator_impl.get_metric_measurement(metric_name)
